...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(centerface_oe_3_2_0) // Defines NN_Instance_centerface_oe_3_2_0 and NN_Interface_centerface_oe_3_2_0 with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[0];
AI_ALIGNED(32)
static ai_u8 activations_2[450560];
AI_ALIGNED(32)
...
AI_ALIGNED(32)
static ai_u8 weights_9[7292689];
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_centerface_oe_3_2_0);
  }
}
